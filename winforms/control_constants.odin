...
//DPI Awareness Contexts 
    ...
    // DPI_AWARENESS_CONTEXT_UNAWARE :: DPI_AWARENESS_CONTEXT(cast(UINT_PTR)(U64MAX-1) + 1)
    DPI_AWARENESS_CONTEXT_SYSTEM_AWARE :: DPI_AWARENESS_CONTEXT(cast(UINT_PTR)(U64MAX - 2) + 1)
    // DPI_AWARENESS_CONTEXT_PER_MONITOR_AWARE :: DPI_AWARENESS_CONTEXT(cast(UINT_PTR)(U64MAX-3) + 1)
    // DPI_AWARENESS_CONTEXT_PER_MONITOR_AWARE_V2 :: DPI_AWARENESS_CONTEXT(cast(UINT_PTR)(U64MAX-4) + 1)
    // DPI_AWARENESS_CONTEXT_UNAWARE_GDISCALED :: DPI_AWARENESS_CONTEXT(cast(UINT_PTR)(U64MAX-1) + 5)
...
// DTP constants.
    ...
    DTN_DATETIMECHANGE :: (DTN_FIRST + 1) //DTN_FIRST2-6
    DTN_DROPDOWN :: (DTN_FIRST + 6)//u64(18446744073709550862) // DTN_FIRST2 - 1
    DTN_CLOSEUP :: (DTN_FIRST + 7) //u64(18446744073709550863) //DTN_FIRST2
    DTN_USERSTRINGW :: (DTN_FIRST + 15) //(DTN_FIRST-5)
    DTN_WMKEYDOWNW :: (DTN_FIRST + 3)   //(DTN_FIRST-4)
    DTN_FORMATW :: (DTN_FIRST + 17) //(DTN_FIRST-3)
    DTN_FORMATQUERYW :: (DTN_FIRST + 18) //(DTN_FIRST-2)
    DTN_USERSTRING :: (DTN_FIRST + 15)
...
// TextBox constants.
    ...
    UIS_CLEAR :: 2
    UISF_HIDEFOCUS :: 0x1
    TBSTYLE :: ES_LEFT | ES_AUTOHSCROLL | WS_OVERLAPPED |
